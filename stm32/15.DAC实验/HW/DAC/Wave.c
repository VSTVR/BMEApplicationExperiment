...
void Amplitude_add(u8 mode)
{
  if(mode!=0)
  {
    ...
    {
      case 1://正弦
        if(findmax(s_arrSineWave100Point)<4030)
        {
            changewavearr((u16*)(s_arrSineWave100Point),1.1);
        }
        break;
      case 2://三角
        if(findmax(s_arrTriWave100Point)<4030)
        {
            changewavearr((u16*)(s_arrTriWave100Point),1.1);
        }
        break;
      case 3://方波
        if(findmax(s_arrRectWave100Point)<4030)
        {
          changewavearr((u16*)(s_arrRectWave100Point),1.1);
        }
        break;
      default:
        break;
...
void  Amplitude_dec(u8 mode)
{
  if(mode!=0)
  {
    ...
    {
      case 1://正弦
        if(findmax(s_arrSineWave100Point)>400)
        {
            changewavearr((u16*)(s_arrSineWave100Point),0.9);
        }
        break;
      case 2://三角
        if(findmax(s_arrTriWave100Point)>400)
        {
            changewavearr((u16*)(s_arrTriWave100Point),0.9);
        }
        break;
      case 3://方波
        if(findmax(s_arrRectWave100Point)>400)
        {
          changewavearr((u16*)(s_arrRectWave100Point),0.9);
        }
        break;
      default:
        break;
